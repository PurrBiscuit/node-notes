...
// referencing -> https://www.freecodecamp.org/news/the-complete-guide-to-this-in-javascript/
...
console.log('---------------------------------------------------')
console.log('Calling getA with default binding of global object:')
console.log('---------------------------------------------------')
...
console.log(`\n-------------------------------------------------------------`)
console.log('Calling newObj getA with implicit binding from newObj object:')
console.log('-------------------------------------------------------------')
...
console.log(`\n--------------------------------------------------------------------------------------`)
console.log('Assigning newObj.getA function to a new function to show this changing back to global:')
console.log('--------------------------------------------------------------------------------------')
...
console.log(`\n-----------------------------------------------`)
console.log('Binding getA to newerObj with the .bind method:')
console.log('-----------------------------------------------')
...
console.log(`\n--------------------------------------------------------------------`)
console.log('Using .call method to bind and call immediately getA with newestObj:')
console.log('--------------------------------------------------------------------')
...
console.log(`\n---------------------------------------------------------------------------`)
console.log('Using a class to show this getting bound to the object after instantiation:')
console.log('---------------------------------------------------------------------------')
